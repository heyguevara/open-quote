 ...
 * @source $Source: /home/bob/CVSRepository/projects/insurance/insurance.ear/insurance.jar/com/ail/insurance/quotation/calculatebrokerage/CalculateBrokerageArgImp.java,v $
 * @stereotype argimp
 */
public class CalculateBrokerageArgImp extends CommandArgImp implements CalculateBrokerageArg {
    static final long serialVersionUID = 1199346453402049909L;

    /** The policy to calculate brokerage for */
    private Policy policyArgRet;

    /** Default constructor */
    public CalculateBrokerageArgImp() {
    }
