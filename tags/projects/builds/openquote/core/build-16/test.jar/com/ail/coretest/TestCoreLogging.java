 ...
 * @source $Source: /home/bob/CVSRepository/projects/core/test.jar/com/ail/coretest/TestCoreLogging.java,v $
 */
public class TestCoreLogging extends TestCase implements CoreUser, ConfigurationOwner {
     ...
     */
    public TestCoreLogging(String name) {
        super(name);
    }

    public static Test suite() {
		return new TestSuite(TestCoreLogging.class);
    }
	...
	private Configuration createSimpleConfiguration() {
        ...
        t.setBuilder("ClassBuilder");
        t.setKey("com.ail.core.logging.LoggerCommand");
        p.setName("Accessor");
