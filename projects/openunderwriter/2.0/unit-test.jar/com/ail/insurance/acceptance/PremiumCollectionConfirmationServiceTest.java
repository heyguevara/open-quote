...
import static com.ail.financial.PaymentRecordType.AUTORISED;
...
import com.ail.insurance.acceptance.PremiumCollectionAuthorisedService.PremiumCollectionConfirmationArgument;
...
public class PremiumCollectionConfirmationServiceTest {
    ...
    @Mock
    PremiumCollectionConfirmationArgument argument;
    @Mock
    Policy policy;
    @Mock
    ...
    public void setup() {
        ...
        doReturn(AUTORISED).when(requestApproved).getType();
