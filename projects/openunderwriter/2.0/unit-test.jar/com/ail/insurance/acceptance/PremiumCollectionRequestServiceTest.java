...
public class PremiumCollectionRequestServiceTest {
    ...
    @Test(expected = PreconditionException.class)
    public void checkThatNonON_RISKlPolicyStatusIsTrapped() throws BaseException {
    ...
    public void checkThatAnEmptyMoneyProvisionIsTrapped() throws BaseException {
        List<MoneyProvision> emptyList=new ArrayList<MoneyProvision>();
        doReturn(emptyList).when(paymentSchedule).getMoneyProvision();
        sut.invoke();
    }
    
    @Test(expected=PreconditionException.class)
    public void checkThatPaymentMethodOtherThanPayPalAreTrapped() throws BaseException {
        doReturn(directDebit).when(moneyProvision).getPaymentMethod();
        sut.invoke();
    }
