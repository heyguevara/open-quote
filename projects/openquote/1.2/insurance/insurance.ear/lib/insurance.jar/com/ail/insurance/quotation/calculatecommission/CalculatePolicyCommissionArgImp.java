 ...
 * @source $Source: /home/bob/CVSRepository/projects/insurance/insurance.ear/insurance.jar/com/ail/insurance/quotation/calculatecommission/CalculatePolicyCommissionArgImp.java,v $
 * @stereotype argimp
 */
public class CalculatePolicyCommissionArgImp extends CommandArgImp implements
CalculatePolicyCommissionArg {
    static final long serialVersionUID = 1199346453402049909L;

    /** Policy to calculate commission for. */
    private Policy policyArg;

    /** Assessment Sheet to append commission lines to. */
    private AssessmentSheet assessmentSheetArgRet;

    /** Default constructor */
    public CalculatePolicyCommissionArgImp() {
    }
