 ...
 * @source $Source: /home/bob/CVSRepository/projects/insurance/insurance.ear/insurance.jar/com/ail/insurance/quotation/addpolicynumber/AddPolicyNumberArgImp.java,v $
 * @stereotype argimp
 */
public class AddPolicyNumberArgImp extends CommandArgImp implements AddPolicyNumberArg {
    static final long serialVersionUID = 1199346453402049909L;

    /** The policy to generate a policy number for */
    private Policy policyArgRet;

    /** Default constructor */
    public AddPolicyNumberArgImp() {
    }
