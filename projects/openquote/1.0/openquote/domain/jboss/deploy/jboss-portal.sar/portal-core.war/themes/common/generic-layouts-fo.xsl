...
<xsl:stylesheet xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:variable name="UkLayout">
        ...
        <fo:page-sequence-master master-name="all-pages">
            <fo:repeatable-page-master-alternatives>
                <fo:conditional-page-master-reference
                    ...
                    page-position="first" />
                <fo:conditional-page-master-reference
                    master-reference="other-pages-right"
                    odd-or-even="odd" />
                <fo:conditional-page-master-reference
                    master-reference="other-pages-left"
                    odd-or-even="even" />
                <fo:conditional-page-master-reference
        ...
        <fo:simple-page-master xsl:use-attribute-sets="UkPageSize" master-name="other-pages-right">
            <xsl:copy-of select="$ail-regions-rest-right"/>
        </fo:simple-page-master>
        <fo:simple-page-master xsl:use-attribute-sets="UkPageSize" master-name="other-pages-left">
            <xsl:copy-of select="$ail-regions-rest-left"/>
        </fo:simple-page-master>
        <fo:simple-page-master xsl:use-attribute-sets="UkPageSize" master-name="blank-pages">
    ...
    <xsl:attribute-set name="base-font" use-attribute-sets="Helvetica">
    ...
    <xsl:attribute-set name="normal-font" use-attribute-sets="base-font">
...
<!--    table layouts-->
    ...
    <xsl:attribute-set name="header-block">
        <xsl:attribute name="color"><xsl:value-of select="$font-header-colour"/></xsl:attribute>
        <xsl:attribute name="font-weight">bold</xsl:attribute>
    </xsl:attribute-set>
