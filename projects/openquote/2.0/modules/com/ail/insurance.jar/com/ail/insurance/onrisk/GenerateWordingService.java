...
public class GenerateWordingService extends Service<GenerateWordingService.GenerateWordingArgument> {
    private static final long serialVersionUID = 3198893603833694389L;

    @ServiceArgument
    public interface GenerateWordingArgument extends Argument {
        /**
    ...
    @ServiceCommand(defaultServiceClass=GenerateWordingService.class)
