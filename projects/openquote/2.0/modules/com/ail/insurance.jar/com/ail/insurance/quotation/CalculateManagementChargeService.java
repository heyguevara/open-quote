...
public class CalculateManagementChargeService extends Service<CalculateManagementChargeService.CalculateManagementChargeArgument> {
    private static final long serialVersionUID = 7164742353521557305L;

    @ServiceArgument
    public interface CalculateManagementChargeArgument extends Argument {
        /**
         * Getter for the policyArgRet property. The policy to calculate management charges for and on.
    ...
    @ServiceCommand(defaultServiceClass=CalculateManagementChargeService.class)
    ...
    public void invoke() throws PreconditionException, BaseException {
        ...
        CalculatePolicyManagementChargeCommand command=core.newCommand("CalculatePolicyManagementCharge", CalculatePolicyManagementChargeCommand.class);
