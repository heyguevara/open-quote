...
public class GenerateQuoteService extends Service<GenerateQuoteService.GenerateDocumentArgument> {
    ...
    @ServiceCommand(defaultServiceClass=GenerateQuoteService.class)
