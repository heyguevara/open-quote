...
public class Fact extends Type {
    ...
    /**
     * Evaluate an xpath expresson on the fact's value and return the result as an int.
    ...
    /**
     * Evaluate an xpath expresson on the fact's value and return the result as a String. If the xpath resolves to
    ...
    /**
     * Evaluate an xpath expresson on the fact's value and return the result as a Date. If the xpath resolves to 
