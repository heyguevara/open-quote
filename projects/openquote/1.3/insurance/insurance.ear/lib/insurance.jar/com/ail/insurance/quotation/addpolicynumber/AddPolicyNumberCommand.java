 ...
 * @source $Source: /home/bob/CVSRepository/projects/insurance/insurance.ear/insurance.jar/com/ail/insurance/quotation/addpolicynumber/AddPolicyNumberCommand.java,v $
 * @stereotype command
 */
public class AddPolicyNumberCommand extends Command implements AddPolicyNumberArg {
    private static final long serialVersionUID = 6020205183308695083L;
    private AddPolicyNumberArg args = null;

    public AddPolicyNumberCommand() {
        super();
        args = new AddPolicyNumberArgImp();
    }

    public void setArgs(CommandArg arg) {
        this.args = (AddPolicyNumberArg)arg;
    }
