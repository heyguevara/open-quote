...
import com.ail.core.urlhandler.product.ProductRepositoryService.ProductRepositoryArgument;
import com.liferay.portal.kernel.exception.PortalException;
import com.liferay.portal.kernel.exception.SystemException;
import com.liferay.portal.kernel.repository.model.FileEntry;

public class LiferayProductRepositoryServerTest {

    LiferayProductRepositoryService sut;
    ...
    @Mock
    ProductRepositoryArgument args;
    ...
    public void setUp() throws Exception {
        ...
        sut = spy(new LiferayProductRepositoryService(1234L, "ROOT"));
