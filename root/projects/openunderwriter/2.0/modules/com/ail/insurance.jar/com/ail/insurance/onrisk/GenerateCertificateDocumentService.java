...
public class GenerateCertificateDocumentService extends Service<GenerateCertificateDocumentService.GenerateCertificateDocumentArgument> {
    private static final long serialVersionUID = 3198893603833694389L;

    @ServiceArgument
    public interface GenerateCertificateDocumentArgument extends Argument {
        /**
    ...
    @ServiceCommand(defaultServiceClass=GenerateCertificateDocumentService.class)
    public interface GenerateCertificateDocumentCommand extends Command, GenerateCertificateDocumentArgument {}
	...
	public void invoke() throws BaseException {
        ...
        gdc.setDocumentDefinitionArg("CertificateDocument");
