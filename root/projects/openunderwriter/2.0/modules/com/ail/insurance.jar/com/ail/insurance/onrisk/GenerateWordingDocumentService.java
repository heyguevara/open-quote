...
/**
 * Service to generate an wording document. This service delegates to the three document generation phase services: Merge, Style and
 * Render. The actual services used in the generation phases depends on the {@link DocumentDefinition} type defined in the product
 * associated with the policy for which a document is being generated. By convention, this type is named "InvoiceDocument".
 */
@ServiceImplementation
public class GenerateWordingDocumentService extends Service<GenerateWordingDocumentService.GenerateWordingDocumentArgument> {
    private static final long serialVersionUID = 3198893603833694389L;

    @ServiceArgument
    public interface GenerateWordingDocumentArgument extends Argument {
        /**
    ...
    @ServiceCommand(defaultServiceClass=GenerateWordingDocumentService.class)
    public interface GenerateWordingDocumentCommand extends Command, GenerateWordingDocumentArgument {}
    ...
    public void invoke() throws BaseException {
        ...
        gdc.setDocumentDefinitionArg("WordingDocument");
