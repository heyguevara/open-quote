...
public class PageFlowCommon {
    ...
    void doView(RenderRequest request, RenderResponse response) throws IOException, BaseException {
        PageFlow pageFlow = PageFlowContext.getPageFlow();
        Policy policy = PageFlowContext.getPolicy();
    ...
    /**
     * Persist the current quotation. Take the quotation from the context, and
