...
grant select on AIL_Base_DataSource_Master_Motor.* to 'report'@'localhost' identified by 'e98d2f001da5678b39482efbdf5770dc';
...
grant select on MetropolitanInsurance_Motor_Staging.* to 'report'@'localhost' identified by 'e98d2f001da5678b39482efbdf5770dc';
...
grant select on StarInsurance_Motor_Staging.* to 'report'@'localhost' identified by 'e98d2f001da5678b39482efbdf5770dc';
...
grant select on AIL_Base_DataSource_Test.* to 'report'@'localhost' identified by 'e98d2f001da5678b39482efbdf5770dc';
