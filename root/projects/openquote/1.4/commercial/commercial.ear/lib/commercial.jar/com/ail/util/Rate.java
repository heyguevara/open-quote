...
public class Rate extends Type {
    ...
    public void setRate(String rate) throws IllegalArgumentException, NumberFormatException {
        ...
        if (rate.endsWith("%")) {
            ...
            if (nominator.doubleValue()<0 || nominator.doubleValue()>100) {
            ...
            if (nominator.doubleValue()<0 || nominator.doubleValue()>denominator.doubleValue()) {
                throw new IllegalArgumentException("Nominator ("+nominator+") greater than denominator ("+denominator+")");
            }
            ...
            if (nominator.doubleValue()<0 || nominator.doubleValue()>1000) {
                throw new IllegalArgumentException(nominator+" is not a valid percentage value");
            }
        }
        else {
