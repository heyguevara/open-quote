 ...
 */
public class GenerateCertificateService extends Service {
    private static final long serialVersionUID = 3198893603833694389L;
    private GenerateCertificateArg args=null;
	private Core core=null;

	public GenerateCertificateService() {
		core=new Core(this);
    }

    public GenerateCertificateService(Core core) {
        this.core=core;;
    }

	/**
     * Getter to fetch the entry point's core. This method is demanded by
    ...
    public void setArgs(CommandArg args){
        this.args = (GenerateCertificateArg)args;
    }
	...
	public void invoke() throws BaseException {
        ...
        DocumentDefinition docDef=(DocumentDefinition)core.newProductType(args.getPolicyArg().getProductTypeId(), "Certificate");
