...
/**
 * Service to notify a broker of the existence of a quote. Typical implementations of this service include
 * notifying brokers of the creation of a new quotation. The implementation might send notification 
 ...
 */
@ArgumentDefinition
public interface NotifyBrokerArgument extends Argument {
