...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body id="body">
			...
			<div id="sizer">
				<div id="expander">
					...
					<div id="content-container">
						<p:region regionName='top-center' regionID='regionA' /> 
						<p:region regionName='bottom-left' regionID='regionB' /> 
						<p:region regionName='bottom-right' regionID='regionC' />
						<hr class="cleaner" />
					</div>
				</div>
			</div>
		...
		<style type="text/css">ul#tabsHeader a{ visibility : visible }</style>
	</body>
</html>
