...
/**
 * This class is mapped to the database to represent a summary of each persisted policy. In
 * effect it defines the fields broken out of the policy object graph to allow for searching
 * and reporting.
 */
@TypeDefinition
public class SavedPolicySummary extends Type {
