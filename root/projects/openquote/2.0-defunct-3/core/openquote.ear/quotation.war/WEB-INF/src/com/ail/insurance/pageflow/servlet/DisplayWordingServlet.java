 ...
 */
package com.ail.insurance.pageflow.servlet;
...
public class DisplayWordingServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.setHeader("Content-Disposition", "attachment;filename=\"Wording-"+policyNumber+".pdf\"");
        ...
        try {
            ...
            e.printStackTrace();
            throw new ServletException("Failed to fetch wording (number:"+policyNumber+") for display.");
        }
