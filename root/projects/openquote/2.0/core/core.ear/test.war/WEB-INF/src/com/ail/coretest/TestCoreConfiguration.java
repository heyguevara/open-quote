 ...
 * @source $Source: /home/bob/CVSRepository/projects/core/test.jar/com/ail/coretest/TestCoreConfiguration.java,v $
 */
public class TestCoreConfiguration extends TestCase implements CoreUser, ConfigurationOwner {
     ...
     */
    public TestCoreConfiguration(String name) {
        super(name);
    }

    public static Test suite() {
		return new TestSuite(TestCoreConfiguration.class);
    }
     ...
     * <li>Fail if no exception is thrown - versionEffectiveDate is still set to
    ...
    public void testGettingConfigurationSource() {
        try {
            ...
            for(String s: core.getConfigurationSource()) {
	...
	public void testTimoutCachePerformace() {
        try {
            ...
            // second loop should be a lot faster than the first - test that it is ~ twice as fast. Setting the bar pretty low.
            assertTrue("Caching not effective: was "+secondLoop+" max is:"+firstLoop, ((double)secondLoop/firstLoop)<.6);
        }
        catch(Throwable e) {
            fail("Unexpected exception:"+e);
        }
