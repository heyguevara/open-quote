...
public class TestProductServices extends CoreUserTestCase {
    ...
    public void testConfigurationSource() {
        ...
        assertTrue(getCore().getConfiguration().getSource().endsWith("jboss/server/default/deploy/core.ear/test.war/WEB-INF/classes/com/ail/coretest/TestProductServicesDefaultConfig.xml"));
    }
