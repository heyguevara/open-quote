...
public class TestEJBConfigurationLoader extends TestCase {
    private String savedLoader=null;
    private String savedContext=null;
    private String savedProvider=null;
	private AbstractConfigurationLoader loader=null;
	private String TestNamespace="TESTNAMESPACE";

    /** Constructs a test case with the given name. */
    public TestEJBConfigurationLoader(String name) {
        super(name);
    }

    public static Test suite() {
		return new TestSuite(TestEJBConfigurationLoader.class);
    }
    ...
    protected void setUp() {
        savedLoader=System.getProperty("com.ail.core.configure.loader");
        savedContext=System.getProperty(Context.INITIAL_CONTEXT_FACTORY);
        savedProvider=System.getProperty(Context.PROVIDER_URL);
    ...
    protected void tearDown() {
        if (savedLoader!=null){
            System.setProperty("com.ail.core.configure.loader", savedLoader);
        }
        else {
            System.clearProperty("com.ail.core.configure.loader");
        }

        if (savedContext!=null) {
            System.setProperty(Context.INITIAL_CONTEXT_FACTORY, savedContext);
        }
        else {
        ...
        if (savedProvider!=null) {
            System.setProperty(Context.PROVIDER_URL, savedProvider);
        }
        else {
     ...
     * <li>Load the original configuration by specifying a timestamp before the 1 second delay.</li>
