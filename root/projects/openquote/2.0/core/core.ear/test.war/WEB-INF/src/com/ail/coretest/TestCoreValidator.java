...
import com.ail.core.validator.CommonsValidatorService;
import com.ail.core.validator.ValidatorCommand;
import com.ail.core.validator.ValidatorFailureDetail;
...
/**
 * Test the core's validation services
 */
...
public class TestCoreValidator extends CoreUserTestCase {
    ...
    public static Test suite() {
		return new TestSuite(TestCoreValidator.class);
    }
	...
	*/
	 ...
	 */
/*
	public void testValidatorServiceXMLSuccess() throws Exception {
		// set up key & value & validation
		String key = "TestForm";
		
		String value = "<a><string name=\"string1\">ONE</string><string name=\"string2\">TWO</string></a>";
		...
		System.out.println();
		System.out.println("testValidatorServiceXMLSuccess");
		System.out.println(error);	
