...
(function() {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			// AIL - Change to allow smaller hight text areas than default
			if(h < (t.getParam('theme_advanced_resizing_min_height') || 100))
			    h = (t.getParam('theme_advanced_resizing_min_height') || 100);
			// AIL - End
