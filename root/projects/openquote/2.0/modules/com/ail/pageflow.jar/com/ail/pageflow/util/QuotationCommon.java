...
public class QuotationCommon {
    ...
    public static String buildProductSelectOptions(String product) {
        try {
            ListProductsCommand lpods = new CoreProxy().newCommand(ListProductsCommand.class);
            ...
            for (ProductDetails p : lpods.getProductsRet()) {
                ...
                // at the moment the product catalog doesn't have sufficient
                // structure to indicate whether a product is "abstract" - i.e.
                // it cannot be quoted from but is instead a base which other
                // products extend.
