...
public class SandpitPortlet extends GenericPortlet {
    ...
    public void processAction(ActionRequest request, ActionResponse response) {
        ...
        try {
            if (request.getParameter("saveAsTestcase") != null) {
                ...
                String selectedProduct=QuotationContext.getQuotation().getProductTypeId();
                ...
                SavedQuotation q = (SavedQuotation) core.queryUnique("get.savedQuotation.by.quotationNumber", selectedQuote);
                if (q != null) {
                ...
                if (!"XML".equals(getCurrentView(request)) && "XML".equals(selectedView)) {
                    if (session.getAttribute("quoteXml") == null) {
                        session.setAttribute("quoteXml", core.toXML(QuotationContext.getQuotation()));
                    }
                    ...
                    Quotation quote = (Quotation) core.fromXML(Quotation.class, quoteXml);
                ...
                try {
                    ...
                    // from being able to get the Quotation as there is no
    ...
    public void doView(RenderRequest request, RenderResponse response) throws IOException {
        ...
        try {
            ...
            // the product's Quotation.xml has errors) then create a dummy quote
