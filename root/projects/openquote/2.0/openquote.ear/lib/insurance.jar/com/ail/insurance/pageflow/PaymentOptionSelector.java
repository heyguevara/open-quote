 ...
 * one from the list</p>
 * <p>The options to be listed are defined by the {@link com.ail.openquote.Policy#getPaymentOption() 
 * Policy.getPaymentOption()}. Each option comprises a {@link com.ail.financial.PaymentSchedule PaymentSchedule}; when
 * an option is selected, the associate schedule is copied to {@link com.ail.openquote.Policy#setPaymentDetails(PaymentSchedule) 
 * Policy.setPaymentDetails()} and therefore defines how payments will be made for this policy.</p>
