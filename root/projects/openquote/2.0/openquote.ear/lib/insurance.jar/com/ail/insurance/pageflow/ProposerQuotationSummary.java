...
/**
 * <p>This PageElement renders a summary of a quotation which is aimed at proposer. The detailed format of the element
 ...
 * <img src="doc-files/BrokerQuotationSummary-2.png"/></p>
 * 
 ...
 */
public class ProposerQuotationSummary extends PageContainer {
    private static final long serialVersionUID = -4810599045554021748L;

    public ProposerQuotationSummary() {
        super();
    }
	...
	public Type renderResponse(RenderRequest request, RenderResponse response, Type model) throws IllegalStateException, IOException {
    	try {
	    	RenderCommand command=QuotationContext.getCore().newCommand("RenderProposerQuotationSummary", 
