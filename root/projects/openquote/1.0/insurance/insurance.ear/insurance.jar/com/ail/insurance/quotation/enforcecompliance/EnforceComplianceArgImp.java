 ...
 * @source $Source: /home/bob/CVSRepository/projects/insurance/insurance.ear/insurance.jar/com/ail/insurance/quotation/enforcecompliance/EnforceComplianceArgImp.java,v $
 * @stereotype argimp
 */
public class EnforceComplianceArgImp extends CommandArgImp implements EnforceComplianceArg {
    static final long serialVersionUID = 1199346453402049909L;

    /** The policy to enforce compliance for */
    private Policy policyArgRet;

    /** Default constructor */
    public EnforceComplianceArgImp() {
    }
