...
public class AddContentDialog extends BaseContentWizard
{
   ...
   {
      // Start of AIL mod
      this.file=generateTempFileFromFilename(getFileName());
      // End of AIL mod
   ...
   public static File generateTempFileFromFilename(String filename) throws IOException {
       System.out.println("Generated temp File for: "+filename);
       return new File(TempFileProvider.getSystemTempDir().getCanonicalPath()+File.separatorChar+filename);
   }
