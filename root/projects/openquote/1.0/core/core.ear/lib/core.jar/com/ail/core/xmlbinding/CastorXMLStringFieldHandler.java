 ...
 * contents of that string to be embdedded into the XML generaged by {@link com.ail.core.xmlbinding.ToXMLCommand ToXMLCommand}
 * as though it were an inherent node in the XML, and for {@link com.ail.core.xmlbinding.FromXMLCommand FromXMLCommand} to 
 * read the embedded nodes into the XMLString insrance.<p/> 
 ...
 * Assuming that you have an object (com.core.MyObject) which declates an XMLString property <code>myBitOfXml</code> with the appropriate getters 
