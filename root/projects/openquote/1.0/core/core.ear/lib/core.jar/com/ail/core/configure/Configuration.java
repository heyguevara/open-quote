...
public class Configuration extends Group {
    ...
    /**
     * Set the XML mapping definition for this configuration. Each configuration
     * can define its own mapping between XML and java objects. The format of
     * this mapping is dependent upon the XML service being used, but this
     * property is used to define mappings where they can be expressed in
     * string form (e.g. castor XML mappings).
     ...
     * @see #setXmlMapping
     * @return The mapping for this configuration.
     */
