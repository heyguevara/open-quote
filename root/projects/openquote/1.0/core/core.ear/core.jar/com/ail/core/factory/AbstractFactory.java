...
public abstract class AbstractFactory {
     ...
     * This method may be overriden by concrete factories, or used as it is.
     * Its purpose is to initialise the object (o) with the property values
     * defined in the typespec.
     * @param o The object to be initialised
     ...
     * can produce a significant performace gain if the factory's instantiation
     ...
     * 
     * @return true if prototyles should be cached, false otherwise.
     */
    ...
    protected com.ail.core.Type mergeWithBase(com.ail.core.Type subject, Type typeSpec, Core core) {
        ...
        try {
            extendType=typeSpec.xpathGet("parameter[nameLowerCase='extends']/value", String.class);
        }
        catch(Throwable e) {
        ...
        com.ail.core.Type from=(com.ail.core.Type)core.newType(extendType);
        
        subject.mergeWithDataFrom(from, core);
