 ...
 * @source $Source: /home/bob/CVSRepository/projects/core/test.jar/com/ail/coretest/TestCoreHibernatePersistence.java,v $
 */
...
//            ab.getParty().add(new Person("Richard", "Anderson", new Address("The House", "The Lane", null, null, "PO9 11Q")));
//            ab.getParty().add(new Organisation("Scatterblat Limited", new Address("Scatterblat Houst", null, null, null, "SC1 TBL")));
//            Person me=new Person("Jimbo", "Clusknasty", new Address("Cluck House", "Cluck Streen", null, null, "CL0 19Q"));
//            me.addAttribute(new Attribute("shoe size", "9", "string"));
//            ab.setMe(me);
//
//            ab.addAttribute(new Attribute("colour", "dark red", "string"));
//            ab.addAttribute(new Attribute("finish", "eggshell", "string"));
//            
//            getCore().create(ab);
//            
//            id=ab.getSystemId();
...
//            getCore().openPersistenceSession();
//            
//            AddressBook ab=getCore().load(AddressBook.class, id);
//            
//            // this will throw a classcastexception if polymorphism isn't working.
//            Person me=(Person)ab.getMe();
//            
//            assertEquals("9", me.xpathGet("attribute[id='shoe size']/value"));
//            
//            for(Party p: ab.getParty()) {
//                System.out.println("type:"+p.getClass().getName());
//            }
//            
//            assertEquals("dark red", ab.xpathGet("attribute[id='colour']/value"));
//            assertEquals("eggshell", ab.xpathGet("attribute[id='finish']/value"));
//        }
//    }
     ...
     * @throws Exception
     */
    public void testHibernateRemoteCreateSuccess() throws Exception {
        // set up object
        Attribute attr = new Attribute();
        attr.setId("ATTR1");
        attr.setFormat("int");
        ...
        CreateCommand command = (CreateCommand) getCore().newCommand("TestCreateCommandRemote");
        command.setObjectArg(attr);
