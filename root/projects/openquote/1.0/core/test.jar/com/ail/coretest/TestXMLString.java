 ...
 */
public class TestXMLString extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(TestXMLString.class);
    }
    ...
    public void testXsiTypeDetectionWithSpace() {
        ...
        assertEquals("failed with space and and header", "com.ail.insurance.policy.Policy", xml.getXsiType());

        xml = new XMLString(
                "  <quoteSection xsi:type=\"java:com.ail.insurance.policy.Policy\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">");
        assertEquals("failed with space but without header", "com.ail.insurance.policy.Policy", xml.getXsiType());

        xml = new XMLString(
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                        + "<quoteSection xsi:type=\"java:com.ail.insurance.policy.Policy\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">");
        assertEquals("failed without space but with header", "com.ail.insurance.policy.Policy", xml.getXsiType());
