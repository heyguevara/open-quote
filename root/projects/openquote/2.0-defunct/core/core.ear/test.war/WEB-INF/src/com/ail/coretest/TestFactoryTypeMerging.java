...
//       tidyUpTestData();
    ...
    public void testXmlInclude() throws Exception {
        ...
        System.out.println(getCore().toXML(h).toString());
     ...
     * let users move products and their types around in CMS without having to edit the content of the
     * types which those products define. For this reason, we extend the XML parser to support relative 
     * URLs. This test builds an instance of a type which includes using a relative URI.
     * @throws Exception
     */
