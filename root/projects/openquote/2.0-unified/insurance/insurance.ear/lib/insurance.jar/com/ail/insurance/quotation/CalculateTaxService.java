...
public class CalculateTaxService extends Service<CalculateTaxService.CalculateTaxArgument> {
    private static final long serialVersionUID = -4915889686192216902L;

    @ServiceArgument
    public interface CalculateTaxArgument extends Argument {
        /**
    ...
    @ServiceCommand(defaultServiceClass=CalculateTaxService.class)
    public interface CalculateTaxCommand extends Command, CalculateTaxArgument {
    }
    ...
    public void invoke() throws PreconditionException, BaseException {
        ...
        assessmentSheet.removeLinesByOrigin("CalculateTax");
