...
public class GenerateCertificateService extends Service<GenerateCertificateService.GenerateCertificateArgument> {
    private static final long serialVersionUID = 3198893603833694389L;

    @ServiceArgument
    public interface GenerateCertificateArgument extends Argument {
        /**
    ...
    @ServiceCommand(defaultServiceClass=GenerateCertificateService.class)
    public interface GenerateCertificateCommand extends Command, GenerateCertificateArgument {}
