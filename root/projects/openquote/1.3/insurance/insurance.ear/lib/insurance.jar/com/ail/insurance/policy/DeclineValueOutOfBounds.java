...
/**
 * This type of assessment line automatically declines a quotation if a line's value falls outside 
 * defined limits. The line defines a minimum and maximum value and the name of the line that the 
 * limit applies to. If the line's value is found to be outside of these limits a decline line
 ...
 */
public class DeclineValueOutOfBounds extends ControlLine {
    ...
    public DeclineValueOutOfBounds() {
    }
     ...
     */
    public DeclineValueOutOfBounds(String id, String reason, String relatesTo, CurrencyAmount minimum, CurrencyAmount maximum) {
