...
public class Variables extends Type {
    ...
    /**
     * Determin whether the value of variable 'name' falls between min and max inclusive.
    ...
    /**
     * Determin if the value of variable 'name' matches a specified
    ...
    /**
     * Determin if debugging is turned on or off
