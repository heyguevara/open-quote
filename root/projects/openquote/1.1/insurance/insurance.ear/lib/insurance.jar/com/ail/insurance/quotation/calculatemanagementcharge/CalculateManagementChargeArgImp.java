 ...
 * @source $Source: /home/bob/CVSRepository/projects/insurance/insurance.ear/insurance.jar/com/ail/insurance/quotation/calculatemanagementcharge/CalculateManagementChargeArgImp.java,v $
 * @stereotype argimp
 */
public class CalculateManagementChargeArgImp extends CommandArgImp implements
CalculateManagementChargeArg {
    static final long serialVersionUID = 1199346453402049909L;

    /** The policy to calculate management charges for and on. */
    private Policy policyArgRet;

    /** Default constructor */
    public CalculateManagementChargeArgImp() {
    }
