 ...
 */
public enum ClauseType implements TypeEnum {
    CONDITION("Condition"),
    EXCLUSION("Exclusion"),
    EXTENSION("Extension"),
    GUARENTEE("Guarentee"),
     ...
     */
    public static ClauseType forName(String name) {
        return (ClauseType)Functions.enumForName(name, values());
    }
